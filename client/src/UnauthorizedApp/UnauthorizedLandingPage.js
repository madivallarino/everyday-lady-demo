    ...
    <div className="everythingbox">
         ...
         <div className="topbox">
          ...
          <div className="middlebox">
              ...
              <a href="/lifestyles"><div className="ad2">
            ...
            <div className="ad3"><a href="/clothings">
...
export default UnauthorizedLandingPage;